...
FLAGS_WINDOWS = -I include -I include\freetype2 -L lib -llibglfw3 -lgdi32 -lglew32s -lglut32 -lopengl32 -llibfreetype -DGLEW_STATIC -static -static-libgcc -static-libstdc++
